            ...
            <div class="col-sm-12">
                ...
                <div class="row">
                    <div class="col-md-3 bottom-banner">
                        <a href="https://www.leasedadspace.com/ad/visitBannerLink/1401191" target="_blank">
                            <img src="http://i.imgur.com/KhD436r.gif" class="img-responsive  center-block">
                        </a>
                    </div>
                    <div class="col-md-3 bottom-banner">
                        <a href="https://www.leasedadspace.com/ad/visitBannerLink/1484770" target="_blank" class="">
                            <img src="http://i.imgur.com/KhD436r.gif" class="img-responsive center-block">
                        </a>
                    </div>
                    <div class="col-md-3 bottom-banner">
                        <a href="https://www.leasedadspace.com/ad/visitBannerLink/1441446" target="_blank" class="">
                            <img src="https://opptracker.com/IMAGES/GG/TheDownliner125.jpg" class="img-responsive center-block">
                        </a>
                    </div>
                    <div class="col-md-3 bottom-banner">
                        <a href="https://www.leasedadspace.com/ad/visitBannerLink/616" target="_blank" class="">
                            <img src="http://1goldmine.com/ban5.gif" class="img-responsive center-block">
                        </a>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-2 gutter-ad-txt">
                        <a href="https://www.leasedadspace.com/ad/visitTextLink/1132754" target="_blank" class="text-center">
                            <div class="title">Autopilot Income System</div>
                            <!-- #{title}-->
                            <div>Easy Viral List Building</div>
                            <!-- #{line1}-->
                            <div>Earn Upto $500/Day Or More</div>
                            <!-- #{line2}-->
                            <div class="title">Get Instant Access Now :)</div>
                        </a>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="col-sm-2 pull-right">
                            <div class="gutter-ad-txt">
                                <a href="https://www.leasedadspace.com/ad/visitTextLink/1132754" target="_blank" class="text-center">
                                    <div class="title">Blow Your Mind!</div>
                                    <!-- #{title}-->
                                    <div>System that sells itself</div>
                                    <!-- #{line1}-->
                                    <div>and fattens the wallet!</div>
                                    <!-- #{line2}-->
                ...
                <div class="row">
                    <div class="col-md-6 bottom-banner">
                        <a href="https://www.leasedadspace.com/ad/visitBannerLink/120466" target="_blank">
                            <img src="http://thedownliner.com/images/468b.jpg" class="img-responsive  center-block fourSixtyEightImage">
                        </a>
                    </div>
                    <div class="col-md-6 bottom-banner">
                        <a href="https://www.leasedadspace.com/ad/visitBannerLink/84576" target="_blank" class="">
                            <img src="http://Soload1.successjrnw.com/imagesrte/D171879/images-LL-Banners/59327.gif" class="img-responsive center-block fourSixtyEightImage">
                        </a>
                    </div>
                </div>
