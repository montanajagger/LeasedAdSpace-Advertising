            ...
            <div class="col-sm-12">
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <p><strong>You can make up to 75% commissions off of 7 different levels of traffic packages sales, as well as our other products like <a href="{{env('APP_URL'). '/para/info'}}">ParaAds</a>.</strong></p>

                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6 bottom-banner">
                        <a href="https://www.leasedadspace.com/ad/visitBannerLink/28" target="_blank">
                            <img src="https://theconversionpros.com/office/resource/user/files/70/814270/6823_20151102045512.jpg" class="img-responsive  center-block fourSixtyEightImage">
                        </a>
                    </div>
                    <div class="col-md-6 bottom-banner">
                        <a href="https://www.leasedadspace.com/ad/visitBannerLink/25" target="_blank" class="">
                            <img src="https://theconversionpros.com/office/resource/user/files/70/814270/6823_20151102045512.jpg" class="img-responsive center-block fourSixtyEightImage" style="display: block !important;">
                        </a>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="gutter-ad-txt">
                            <a href="https://www.leasedadspace.com/ad/visitTextLink/1370088" target="_blank" class="text-center">
                                <div class="title">Digital Marketing for Entrepreneur</div>
                                <!-- #{title}-->
                                <div>We here to help people,</div>
                                <!-- #{line1}-->
                                <div>make a success.</div>
                                <!-- #{line2}-->
                    ...
                    <div class="col-sm-4">
                        <div class="gutter-ad-txt">
                            <a href="https://www.leasedadspace.com/ad/visitTextLink/624134" target="_blank" class="text-center">
                                <div class="title">$25-$1000 daily</div>
                                <!-- #{title}-->
                                <div>Bonus for my team members</div>
                                <!-- #{line1}-->
                                <div>easy1up</div>
                                <!-- #{line2}-->
                                <div class="title">turn your computer to ATM</div>
                            </a>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="gutter-ad-txt">
                            <a href="https://www.leasedadspace.com/ad/visitTextLink/52205" target="_blank" class="text-center">
                                <div class="title">$1000's Weekly Online!</div>
                                <!-- #{title}-->
                                <div>Selling TRAFFIC ...</div>
                                <!-- #{line1}-->
                                <div>GUARANTEED CASH!</div>
                                <!-- #{line2}-->
                                <div class="title">Join FREE and Submit FREE Ads daily</div>
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-3 bottom-banner">
                        <a href="https://www.leasedadspace.com/ad/visitBannerLink/1436916" target="_blank">
                            <img src="http://richardweberg.com/images/125x125.gif" class="img-responsive  center-block">
                        </a>
                    </div>
                    <div class="col-md-3 bottom-banner">
                        <a href="https://www.leasedadspace.com/ad/visitBannerLink/67579" target="_blank" class="">
                            <img src="http://richardweberg.com/images/125x125.gif" class="img-responsive center-block">
                        </a>
                    </div>
                    <div class="col-md-3 bottom-banner">
                        <a href="https://www.leasedadspace.com/ad/visitBannerLink/203499" target="_blank" class="">
                            <img src="http://richardweberg.com/images/125x125.gif" class="img-responsive center-block">
                        </a>
                    </div>
                    <div class="col-md-3 bottom-banner">
                        <a href="https://www.leasedadspace.com/ad/visitBannerLink/616" target="_blank" class="">
                            <img src="http://richardweberg.com/images/125x125.gif" class="img-responsive center-block">
                        </a>
                    </div>
                </div>
