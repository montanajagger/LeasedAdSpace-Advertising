		...
		<div class="row">
			<div class="col-sm-10">
				<div class="panel-group" id="accordion">
					<div class="panel panel-default">
						<a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="https://leasedadspace.com/faq/#collapseOne">
						...
						<div id="collapseOne" class="panel-collapse collapse">
							<div class="panel-body">
								...
								<ol>
									<li><a href="https://leasedadspace.com/register.php">Register for an Account</a></li>
					...
					<div class="panel panel-default">
						<a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="https://leasedadspace.com/faq/#collapseAffiliate">
							<div class="panel-heading">
						...
						<div id="collapseAffiliate" class="panel-collapse collapse">
							<div class="panel-body">
								<p>Becoming an LAS affiliate is a great way to both advertise your own products, and make money advertising Leased<strong>Ad</strong>Space products to other potential customers!  More information about being an affiliate <a href="https://leasedadspace.com/howitworks_affiliate">can be found here</a> and you can enable your affiliate account on your <a href="https://leasedadspace.com/dashboard.php">Member Dashboard</a></p>
							</div>
						</div>
					</div>
					<div class="panel panel-default">
						<a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="https://leasedadspace.com/faq/#collapseTwo">
							<div class="panel-heading">
					...
					<div class="panel panel-default">
						<a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="https://leasedadspace.com/faq/#collapseThree">
							<div class="panel-heading">
					...
					<div class="panel panel-default">
						<a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="https://leasedadspace.com/faq/#collapseFour">
							<div class="panel-heading">
					...
					<div class="panel panel-default">
						<a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="https://leasedadspace.com/faq/#collapseFive">
							<div class="panel-heading">
					...
					<div class="panel panel-default">
						<a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="https://leasedadspace.com/faq/#collapseSix">
							<div class="panel-heading">
					...
					<div class="panel panel-default">
						<a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="https://leasedadspace.com/faq/#collapseSeven">
							<div class="panel-heading">
					...
					<div class="panel panel-default">
						<a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="https://leasedadspace.com/faq/#collapseEight">
							<div class="panel-heading">
						...
						<div id="collapseEight" class="panel-collapse collapse">
							<div class="panel-body">
								...
								<p><a href="https://leasedadspace.com/para_info">ParaAds</a> and other products and services have their own unique benefits and distribution methods best explained in their own deailed product descriptions.</p>
							</div>
						</div>
					</div>
					<div class="panel panel-default">
						<a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="https://leasedadspace.com/faq/#collapseNine">
							<div class="panel-heading">
					...
					<div class="panel panel-default">
						<a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="https://leasedadspace.com/faq/#collapseTen">
							<div class="panel-heading">
						...
						<div id="collapseTen" class="panel-collapse collapse">
							<div class="panel-body">
								<p>Our affiliate program and compensation plan details are explained in the <a href="https://leasedadspace.com/howitworks_affiliate">How it Works for Affiliates Page</a></p>
					...
					<div class="panel panel-default">
						<a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="https://leasedadspace.com/faq/#collapseTwelve">
							<div class="panel-heading">
				...
				<div class="row">
					<div class="col-sm-6">
						<a href="https://leasedadspace.com/ad/visitBannerLink/30772" target="_blank" class="bottom-banner">
							<img src="http://www.cryptosbuilder.com/images/cbanner1.gif" class="img-responsive center-block fourSixtyEightImage">
						</a>
					</div>
					<div class="col-sm-6">
						<a href="https://leasedadspace.com/ad/visitBannerLink/75771" target="_blank" class="bottom-banner">
							<img src="http://www.cryptosbuilder.com/images/cbanner1.gif" class="img-responsive center-block fourSixtyEightImage">
						</a>
					</div>
				</div>
			...
			<div class="col-sm-2">
				<div class="row">
					<div class="col-sm-12">
						<div class="gutter-ad-txt">
							<a href="https://leasedadspace.com/ad/visitTextLink/517348" target="_blank" class="text-center">
				...
				<div class="row">
					<div class="col-sm-12">
						<div class="gutter-ad-img-sm">
							<a href="https://leasedadspace.com/ad/visitBannerLink/1111295" target="_blank" class="">
				...
				<div class="row">
					<div class="col-sm-12">
						<div class="gutter-ad-txt">
							<a href="https://leasedadspace.com/ad/visitTextLink/212996" target="_blank" class="text-center">
